...
alias dogerritfixup='git config user.email ttijhof@wikimedia.org && git checkout master && git review -s && git remote rm origin; git remote update && git branch --set-upstream-to gerrit/master master'
