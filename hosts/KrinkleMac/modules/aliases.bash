...
alias dogerritfixup='git config user.email ttijhof@wikimedia.org && git checkout master && git reset --hard HEAD && git review -s && git remote rm origin; git remote update && git branch --set-upstream-to master gerrit/master'
